...
type DashboardMainDarkModeXxsmalldataboxProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "price" | "p2643" | "p110sinceyesterdone"
> &
  Partial<{ price: string; p2643: string; p110sinceyesterdone: string }>;

const DashboardMainDarkModeXxsmalldatabox: React.FC<
  DashboardMainDarkModeXxsmalldataboxProps
> = (props) => {
  return (
    <>
...
DashboardMainDarkModeXxsmalldatabox.defaultProps = {
  price: "CHART TITLE",
  p2643: "2,643",
  p110sinceyesterdone: "1.10% Since yesterday",
};

export default DashboardMainDarkModeXxsmalldatabox;
