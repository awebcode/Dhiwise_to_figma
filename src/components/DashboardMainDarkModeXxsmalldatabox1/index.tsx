...
type DashboardMainDarkModeXxsmalldatabox1Props = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "price" | "p2643" | "p110sinceyesterdone"
> &
  Partial<{ price: string; p2643: string; p110sinceyesterdone: string }>;

const DashboardMainDarkModeXxsmalldatabox1: React.FC<
  DashboardMainDarkModeXxsmalldatabox1Props
> = (props) => {
  return (
    <>
      <div className={props.className}>
        ...
        <Img
          ...
          src="images/img_tinylinechart_amber_200.svg"
          alt="tinylinechart"
        />
      </div>
    </>
...
DashboardMainDarkModeXxsmalldatabox1.defaultProps = {
  price: "CHART TITLE",
  p2643: "2,643",
  p110sinceyesterdone: "1.10% Since yesterday",
};

export default DashboardMainDarkModeXxsmalldatabox1;
