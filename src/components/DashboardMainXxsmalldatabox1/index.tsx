...
type DashboardMainXxsmalldatabox1Props = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "price" | "p2643" | "p110sinceyesterdone"
> &
  Partial<{ price: string; p2643: string; p110sinceyesterdone: string }>;

const DashboardMainXxsmalldatabox1: React.FC<
  DashboardMainXxsmalldatabox1Props
> = (props) => {
  return (
    <>
      <div className={props.className}>
        ...
        <Img
          ...
          src="images/img_tinylinechart_amber_400.svg"
          alt="tinylinechart"
        />
      </div>
    </>
...
DashboardMainXxsmalldatabox1.defaultProps = {
  price: "CHART TITLE",
  p2643: "2,643",
  p110sinceyesterdone: "1.10% Since yesterday",
};

export default DashboardMainXxsmalldatabox1;
